 ...
 */
public class IdListTaskSuiteEditor extends BaseTaskSuiteEditor
    {
    @Override
    ...
    public void editResource(MuseProject project, MuseResource resource)
        ...
        _suite = (IdListTaskSuite) resource;
        ...
        _list_of_ids.addAll(_suite.getTaskIds());
    ...
    public boolean canEdit(MuseResource resource)
        {
        return resource instanceof IdListTaskSuite;
        }
    ...
    private IdListTaskSuite.ChangeListener _listener = new IdListTaskSuite.ChangeListener()
        {
        @Override
        public void taskIdAdded(String id)
            {
            Platform.runLater(() -> _list_of_ids.add(id));
            }

        @Override
        public void taskIdRemoved(String id)
            {
